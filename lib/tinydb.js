...
var Table = /** @class */function () {
    ...
    Table.prototype.insert = function (record) {
        ...
        var promise = new Promise(function (resolve, reject) {
            var addRequest = _this.requestStore().put(record);
    ...
    Table.prototype.update = function (index, record) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            var getRequest = _this.requestStore().get(index);
            getRequest.onsuccess = function () {
                var data = getRequest.result;
                var update_data = __assign(__assign({}, data), record);
                var updateRequest = _this.requestStore().put(update_data);
    ...
    Table.prototype.getByPrimaryKey = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var getRequest = _this.requestStore().get(id);
            getRequest.onsuccess = function () {
...
var TinyDB = /** @class */function () {
    ...
    TinyDB.prototype.upgrade = function () {};
        ...
        var upgrade = function upgrade() {
            ...
            for (var _i = 0, options_1 = options; _i < options_1.length; _i++) {
                ...
                if (!db.objectStoreNames.contains(table.name)) {
                    var record = db.createObjectStore(table.name, {
    ...
    TinyDB.prototype.update = function (table_name, index, record) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            var request = IN_DB.open(_this.dbName, _this.getVersion());
            _this.connect(request).then(function (db) {
                ...
                operator.update(index, record).then(function (res) {
                    return resolve(res);
                }).catch(function (err) {
                    return reject(err);
                });
